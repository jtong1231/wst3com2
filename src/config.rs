...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("运运保".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.wojddw6dd.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 43306;
pub const RELAY_PORT: i32 = 43307;
pub const WS_RENDEZVOUS_PORT: i32 =43308;
pub const WS_RELAY_PORT: i32 = 43309;
